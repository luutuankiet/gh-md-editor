<script lang="ts">
  ...
  const shortcuts: Shortcut[] = [
    ...
    { pane: 'Editor', keys: 'Alt / Opt + Left-click', description: 'Multi-cursor — drop an additional caret at the click point, or click an existing caret to take it away. Works in the markdown editor, the code editor and both diff columns. Combine with Cmd+D for free-form multi-cursor editing.', highlight: true },
