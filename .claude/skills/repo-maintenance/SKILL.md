...
| git asks for a username and password in the integrated terminal, but the same command works in Terminal.app | [GIT_ASKS_FOR_A_PASSWORD_IN_THE_TERMINAL_BUT_NOT_IN_TERMINAL_APP](../../../docs/traps/GIT_ASKS_FOR_A_PASSWORD_IN_THE_TERMINAL_BUT_NOT_IN_TERMINAL_APP.md) | terminal / macOS keychain | 2026-08-20 |
